...
interface MortgageRepository extends CrudRepository<Mortgage, Long> {
    ...
    @Query(value="""\
			select m.idMortgage,m.Lender_idLender_FK,m.LoanType_idLoanType_FK,m.LoanOption_idLoanOption_FK,
			m.fees,m.points,m.apr,m.rate_period,m.nmls_id,m.logo_fileName,m.date,m.monthly_pay,m.name,o.desc,t.description
