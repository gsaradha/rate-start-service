...
interface LenderEquityRepository extends CrudRepository<Lender, Long> {
    ...
    @Query(value="""\
            select idLender,user_name, password, name,email,is_mortgage_lender,nmls_id,state_license,phone,logo_filename,base64_logo,is_verified from
    ...
    @Query(value="""\
            select idLender,user_name, password, name,email,is_mortgage_lender,nmls_id,state_license,phone,logo_filename,is_verified from
