...
interface AutoEquityRepository extends CrudRepository<AutoEquity, Long> {
    ...
    @Query(value="""\
			   select a.idAuto,a.rate,a.apr,a.credit,a.credit_range,a.conditions,a.date,a.logo_filename,
               o.desc,p.description from Auto a join LoanOption o join ProductCondition p join lender l on
